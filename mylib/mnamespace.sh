...
# Funkcja usuwa wszystkie namespace 
...
function main()
{
    options="\"Utwórz network namespace\" \"Pokaż namespace\" \"Wyczyść wszytskie namespace\" \"Dodaj interfejs\" \"Utwórz ovs-switch\" \"Wydaj komende\" \"Wyjście\""
